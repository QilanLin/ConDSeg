...
from utils.run_engine_tganet import load_data, train, evaluate, DATASET
...
if __name__ == "__main__":
    ...
    folder_name = f"TGANET_{dataset_name}_{val_name}_lr{lr}_{current_time}"
    ...
    hyperparameters_str = f"Model: TGANet\nImage Size: {image_size}\nBatch Size: {batch_size}\nLR: {lr}\nEpochs: {num_epochs}\n"
    ...
    model = TGANet(n_channels=3, n_classes=1, bilinear=True)
