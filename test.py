...
def evaluate(model, save_path, test_x, test_y, size):
    ...
    for i, (x, y) in tqdm(enumerate(zip(test_x, test_y)), total=len(test_x)):
        ...
        cv2.imwrite(f"./test_exp1/{name_new}.jpg", p1)
...
if __name__ == "__main__":
    ...
    checkpoint_path = r"C:\Users\Administrator\PycharmProjects\ConDSeg\run_files\Kvasir-SEG\UNet_Kvasir-SEG_None_lr0.0001_20250625-172240\checkpoint.pth"
