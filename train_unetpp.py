...
from utils.run_engine_unetpp import load_data, train, evaluate, DATASET
...
if __name__ == "__main__":
    ...
    folder_name = f"UNETPP_{dataset_name}_{val_name}_lr{lr}_{current_time}"
    ...
    hyperparameters_str = f"Model: U-Net++\nImage Size: {image_size}\nBatch Size: {batch_size}\nLR: {lr}\nEpochs: {num_epochs}\n"
